...
const DISPATCH_COPY: Record<string, { title: string; activity: string; category: DispatchToolCategory }> = {
  ...
  config_list: { title: "Config index", activity: "Reading instructions, skills and personas", category: "config" },
  config_read: { title: "Config read", activity: "Reading authored config", category: "config" },
  config_write: { title: "Config write", activity: "Authoring config", category: "config" },
  config_delete: { title: "Config delete", activity: "Removing authored config", category: "config" },
  mode_list: { title: "Mode index", activity: "Reading modes", category: "config" },
  mode_read: { title: "Mode read", activity: "Reading a mode", category: "config" },
  mode_write: { title: "Mode write", activity: "Authoring a mode", category: "config" },
  mode_delete: { title: "Mode delete", activity: "Removing a mode", category: "config" },
  chat_set_mode: { title: "Set chat mode", activity: "Switching mode", category: "chat" },
  chat_set_persona: { title: "Set chat persona", activity: "Switching persona", category: "chat" },
