...
export const AGENT_TASKS: Record<AgentTaskId, AgentTaskMeta> = {
  ...
  "config:personas": {
    id: "config:personas",
    action: "Configure a persona",
    noun: "persona",
    icon: "Bot",
    blurb: "Creates or updates an optional chat role at project or global scope.",
    placeholder: "e.g. tailor Product owner to ask about audience and success metrics before delegating",
    defaultEffort: "medium",
    instructionsRequired: true,
  },
  "config:skills": {
