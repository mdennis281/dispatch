 ...
 * profiles, the installed desktop shortcut, and an already-installed Electron
 * shell that spawns this server. A shell built before the rename must keep
 * booting a payload built after it. Nothing in-tree sets `CM_*` any more — drop
 * the fallback once the desktop shell has been reinstalled.
 */
